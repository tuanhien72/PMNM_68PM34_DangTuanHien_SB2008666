        ...
        <div class="card app-card">
            <div class="card-body p-4 p-lg-5">
                <div class="mb-4">
                    ...
                    <h1 class="h3 page-heading mb-1">Thêm mới lớp học</h1>
                    <p class="page-subtitle mb-0">Tạo lớp học mới và bổ sung ghi chú cần thiết.</p>
                </div>
                ...
                <form action="<?php echo BASE_URL; ?>/lophoc/store" method="POST">
                    <div class="mb-3">
                        <label class="form-label fw-semibold" for="malop">Mã lớp <span class="text-danger">*</span></label>
                        <input class="form-control" type="text" name="malop" id="malop" maxlength="20" value="<?php echo htmlspecialchars($old['malop'] ?? ''); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold" for="tenlop">Tên lớp <span class="text-danger">*</span></label>
                        <input class="form-control" type="text" name="tenlop" id="tenlop" maxlength="100" value="<?php echo htmlspecialchars($old['tenlop'] ?? ''); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-semibold" for="ghichu">Ghi chú</label>
                        <textarea class="form-control" name="ghichu" id="ghichu" rows="4" maxlength="255"><?php echo htmlspecialchars($old['ghichu'] ?? ''); ?></textarea>
                    </div>
